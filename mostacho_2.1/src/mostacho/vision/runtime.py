...
from mostacho.vision.eyes import compute_ear, get_eye_landmarks_from_face, is_ear_plausible, is_eye_landmark_geometry_valid
...
class VisionRuntimeConfig:
    ...
    # Offset extra para histéresis al volver a abrir ojos.
    ...
    # Cantidad mínima de muestras para cerrar calibración inicial.
    min_calibration_samples: int = 30
    # Ventana de referencias abiertas para recalibración lenta.
    reference_window_size: int = 180
    # Score mínimo de detección para usar un rostro en el detector EAR.
    min_face_score: float = 0.55
    # Ancho horizontal mínimo de cada ojo para EAR estable.
    min_eye_width_px: float = 10.0
    # Diferencia máxima tolerada entre ambos EAR antes de descartar la muestra.
