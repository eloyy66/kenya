...
def _draw_overlay(frame: Any, payload: Dict[str, Any], fps: float) -> Any:
    ...
    cv2.putText(output, f"D-REASON: {distraction_reason}", (15, 180), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (180, 220, 255), 2)
    cv2.putText(output, f"REASON: {run_reason}", (15, 210), cv2.FONT_HERSHEY_SIMPLEX, 0.55, (255, 220, 180), 2)
    cv2.putText(output, f"FPS: {fps:.1f}", (15, 240), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 0), 2)
