...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--detect-width", type=int, default=320, help="Ancho de deteccion")
    # Tamaño de detección de InsightFace.
    parser.add_argument("--detect-height", type=int, default=320, help="Alto de deteccion")
...
def main() -> None:
    ...
    while True:
        ...
        # Analiza frame con runtime visual.
